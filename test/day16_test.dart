...
void main() {
  ...
  group('sample data', tags: 'sample-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 11048);
    });

    test('part2', () async {
      expect(await part2.calculate(file), 77);
    });
  });
  ...
  group('real data', tags: 'real-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 75416);
    });

    test('part2', () async {
      expect(await part2.calculate(file), 476);
    });
  });
}
